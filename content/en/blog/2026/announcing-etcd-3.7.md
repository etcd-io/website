...
- [Features](#features)
  ...
  - [Performance improvements](#performance-improvements)
    ...
    - [Faster, more reliable etcd leases](#faster-more-reliable-etcd-leases)
    - [Faster find() operations](#faster-find-operations)
  - [Other features](#other-features)
    ...
    - [Setting the authentication token directly](#setting-the-authentication-token-directly)
    - [Retrieve AuthStatus without authenticating](#retrieve-authstatus-without-authenticating)
    - [New watch metrics](#new-watch-metrics)
    - [etcdctl command cleanup](#etcdctl-command-cleanup)
- [Upgrading](#upgrading)
  - [Experimental flags removed](#experimental-flags-removed)
  - [Legacy V2 API packages and code cleanup](#legacy-v2-api-packages-and-code-cleanup)
  - [Non-blocking client creation](#non-blocking-client-creation)
  - [Multiarch container images only](#multiarch-container-images-only)
...
*TBD, currently pulling updated contributor list*
