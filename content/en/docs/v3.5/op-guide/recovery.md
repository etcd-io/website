...
NOTE: When restoring a snapshot a --data-dir must be set. This --data-dir should be the same used to start the etcd nodes in order to the the new node know what the restored data is, and avoid conflicts with data dir issues. 
