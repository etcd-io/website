...
**Note that this field has been renamed to `embed.Config.LogOutputs` in `[]string` type in v3.4. Please see [v3.4 upgrade guide](/docs/{{< param version >}}/administration/upgrades/upgrade_3_4/) for more details.**
...
**Note that `embed.Config.SetupLogging` method has been deprecated in v3.4. Please see [v3.4 upgrade guide](/docs/{{< param version >}}/administration/upgrades/upgrade_3_4/) for more details.**
