...
This feature is experimental because it depends on the [google.golang.org/grpc/resolver](https://pkg.go.dev/google.golang.org/grpc/resolver) package, which is still experimental in grpc-go.
{{% /alert %}}
