...
{{% alert color="info" %}}
⚠️ **Note**: Several `--experimental-*` flags have been deprecated in v3.6 and are planned to be removed in v3.7. Be sure to refer to their `--feature-gates=*` replacements when upgrading.
{{% /alert %}}
