...
Discovery uses an existing cluster to bootstrap itself, note that currently it needs etcd v2 to be supported on that cluster. If using a private etcd cluster, create a URL like so:
