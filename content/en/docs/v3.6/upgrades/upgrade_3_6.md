...
To upgrade an existing etcd deployment to 3.6, the running cluster must be 3.5 or greater. If it's before 3.5, please [upgrade to 3.5](../upgrade_3_4/) before upgrading to 3.6.
