...
- Remove this release from [roadmap](https://github.com/etcd-io/etcd/blob/v2.3.8/ROADMAP.md), if necessary.
- Ensure the latest upgrade documentation is available.
- Bump [hardcoded MinClusterVerion in the repository](https://github.com/etcd-io/etcd/blob/v2.3.8/version/version.go#L29), if necessary.
...
- Bump [hardcoded Version in the repository](https://github.com/etcd-io/etcd/blob/v2.3.8/version/version.go#L30) to the latest version `${VERSION}`.
...
- Bump [hardcoded Version in the repository](https://github.com/etcd-io/etcd/blob/v2.3.8/version/version.go#L30) to the version `${VERSION}+git`.
