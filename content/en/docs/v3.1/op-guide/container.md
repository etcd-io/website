...
To provision a 3 node etcd cluster on bare-metal, you might find the examples in the [baremetal repo](https://github.com/poseidon/matchbox/tree/master/examples) useful.
