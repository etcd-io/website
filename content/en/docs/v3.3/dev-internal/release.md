...
- Bump [hardcoded MinClusterVerion in the repository](https://github.com/etcd-io/etcd/blob/v3.3.25/version/version.go#L29), if necessary.
...
- Bump [hardcoded Version in the repository](https://github.com/etcd-io/etcd/blob/v3.3.25/version/version.go#L30) to the latest version `${VERSION}`.
...
- Bump [hardcoded Version in the repository](https://github.com/etcd-io/etcd/blob/v3.3.25/version/version.go#L30) to the version `${VERSION}+git`.
