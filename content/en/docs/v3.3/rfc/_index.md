...
To prove out the design of the v3 API the team has also built [a number of example recipes](https://github.com/etcd-io/etcd/tree/v3.3.25/contrib/recipes), there is a [video discussing these recipes too](https://www.youtube.com/watch?v=fj-2RY-3yVU&feature=youtu.be&t=590).
...
[api-protobuf]: https://github.com/etcd-io/etcd/blob/v3.3.25/etcdserver/etcdserverpb/rpc.proto
[kv-protobuf]: https://github.com/etcd-io/etcd/blob/v3.3.25/mvcc/mvccpb/kv.proto
