...
To upgrade an existing etcd deployment to 3.1, the running cluster must be 3.0 or greater. If it's before 3.0, please [upgrade to 3.0](/docs/v3.3/upgrades/upgrade_3_0/) before upgrading to 3.1.
