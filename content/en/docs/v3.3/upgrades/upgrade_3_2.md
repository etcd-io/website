...
To upgrade an existing etcd deployment to 3.2, the running cluster must be 3.1 or greater. If it's before 3.1, please [upgrade to 3.1](/docs/v3.3/upgrades/upgrade_3_1/) before upgrading to 3.2.
