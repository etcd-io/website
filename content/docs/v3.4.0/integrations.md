...
- [etcd-manager](https://github.com/icellmobilsoft/etcdmanager) - A modern, efficient, multi-platform and free ETCD 3.x GUI & client tool. Available for Windows, Linux and Mac.
